...
This is a FastAPI-based GenAI API template designed for building AI-powered web services. It integrates multiple AI providers (OpenAI, Google Gemini, ElevenLabs) with comprehensive testing and deployment capabilities. The project includes MongoDB Atlas integration with vector search capabilities for RAG applications.
